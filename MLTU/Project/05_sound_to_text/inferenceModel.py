...
if __name__ == "__main__":
    ...
    df = pd.read_csv("Models/05_sound_to_text/202405071029/val.csv").values.tolist()

    #accum_cer, accum_wer = [], []

    
    wav_path =r"C:\Users\LENOVO\Desktop\speech_recognition\MLTU\Datasets\LJSpeech-1.1\wavs\LJ050-0292.wav"
    label="in being comparatively modern"
...
print("true label:", true_label)
        ...
        # wav_path = r"C:\Users\LENOVO\Desktop\speech_recognition\MLTU\Datasets\LJSpeech-1.1\wavs\LJ060-0014.wav"
        #label=""
