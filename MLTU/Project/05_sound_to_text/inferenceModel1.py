...
if __name__ == "__main__":
    ...
    configs = BaseModelConfigs.load(r"C:\Users\LENOVO\Desktop\speech_recognition\Models\05_sound_to_text\202302051936\configs.yaml")

    model = WavToTextModel(model_path=configs.model_path, char_list=configs.vocab, force_cpu=False)

    df = pd.read_csv(r"C:/Users/LENOVO/Desktop/speech_recognition/Models/05_sound_to_text/202405071029/val.csv").values.tolist()

    accum_cer, accum_wer = [], []
    for wav_path, label in tqdm(df):
        wav_path = r"C:\Users\LENOVO\Desktop\speech_recognition\MLTU\Datasets\LJSpeech-1.1\wavs\LJ060-0001.wav"
